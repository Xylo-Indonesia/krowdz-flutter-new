...
class API {
  ...
  static Future<String> registerPost(name, email, password, confirmPassword) async {
  ...
  static Future<String> VisitorList({String keyword='',String keyword_by='',String page='',String order_direction='asc'}) async {
    SharedPreferences prefs=await SharedPreferences.getInstance();
    String access_token=prefs.getString(pref_access_token);
    var client_url=await getClientUrl();
    // print(page);
    ...
    // print(page);
    //var page2='1';
    var url = client_url + '/visitor/list'+'?'+'keyword='+keyword+'&'+'keyword_by='+keyword_by+'&page='+page+'&'+'order_direction='+order_direction+'&order_by='+keyword_by;
    print(url);
    var headers = {
      "Content-Type": "application/json",
      "Accept": "application/json",
  ...
  static Future<dynamic> doRegisterNewActivity(var json,var activityID,var visitorID) async {
    SharedPreferences prefs=await SharedPreferences.getInstance();
    String access_token=prefs.getString(pref_access_token);
    var client_url=await getClientUrl();
  ...
  static Future<dynamic> doEditActivity(var json,var activityID,var visitorID) async {
    SharedPreferences prefs=await SharedPreferences.getInstance();
    String access_token=prefs.getString(pref_access_token);
    var client_url=await getClientUrl();

    var url = client_url + '/activity/history/'+activityID+'/visitor/'+visitorID;
    var headers = {
      // "Content-Type": "application/json",
      // "Accept": "application/json",
      "Authorization": 'Bearer '+access_token,
  ...
  static Future<String> RewardList({String keyword='',String activity=''}) async {
    SharedPreferences prefs=await SharedPreferences.getInstance();
    String access_token=prefs.getString(pref_access_token);
    var client_url=await getClientUrl();
    ...
    try{
      ...
      response = await http.get(url+'?keyword='+keyword+'&activity='+activity, headers: headers);
    }catch(_){
      return {
        "status": "error",
        "message": "Failed to connect to server"
